...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, help='Folder path for model files')
    ...
    parser.add_argument('--unfrozen_epochs', type=int, default=60, help='Final epoch for training')
